...
def play_local_game(white_player, black_player, player_names):
    ...
    history = [Chess(game.truth_board.copy())]
    ...
    while not game.is_over():
        ...
        move_number += 1
        history.append(Chess(game.truth_board.copy()))

        #print("==================================\n")

    winner_color, winner_reason = game.get_winner()

    white_player.handle_game_end(history)
