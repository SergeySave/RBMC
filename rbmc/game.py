...
"""
File Name:      game.py
Authors:        Michael Johnson and Leng Ghuy. Edited by Sergey Savelyev
Date:           March 18th, 2019

Description:    Python file that contains the game mechanics. Everything about time was removed.
...
class Game:
    ...
    def get_seconds_left(self):
        ...
        """
        return 60*5 # Pretend there is 5 minutes left if anything asks
